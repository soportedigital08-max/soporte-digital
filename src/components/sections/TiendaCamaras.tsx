// src/components/sections/TiendaCamaras.tsx
"use client";
...
const PDF_URL = "/descargas/CAMARAS-SEGURIDAD.pdf";

const BENEFICIOS = [
  "Dónde colocar cada cámara: zonas clave y ángulos.",
  "Qué cámaras conviene comprar: tipos y recomendaciones.",
  "Configuración que cierra la puerta: contraseña, 2 pasos, firmware.",
  "Cómo ver desde el celular sin exponer tu hogar.",
  "Señales de que te colaron y qué hacer.",
];

export default function TiendaCamaras() {
  ...
  function armarEnlace() {
    ...
    if (medio === "email" && destino.includes("@")) {
      const body = encodeURIComponent(
        "Gracias por tu compra. Descargá tu guía CÁMARAS Y SEGURIDAD EN EL HOGAR aquí: " + base + PDF_URL
      );
      window.open(
        `mailto:${destino}?subject=${encodeURIComponent(
          "Tu guía CÁMARAS Y SEGURIDAD EN EL HOGAR"
        )}&body=${body}`,
        "_blank"
      );
      ...
      <section className="relative overflow-hidden bg-ink-900">
        ...
        <div className="container relative pt-16 pb-8 text-center max-w-4xl mx-auto">
          ...
          <h1 className="text-h1 font-extrabold leading-[1.05]">
            CÁMARAS Y SEGURIDAD EN EL HOGAR
          </h1>
          <p className="text-body-lg text-primary-100 mt-4">
            Dónde ponerlas, qué comprar y cómo no exponerte. Guía práctica para
            cuidar tu casa sin ser experto.
          </p>
        </div>
      </section>
      ...
      <div className="container max-w-4xl mx-auto pb-20 px-4">
        <div className="grid md:grid-cols-2 gap-8 items-start">
          <div className="rounded-card overflow-hidden border border-white/10 shadow-premium">
            ...
            <img
              src="/descargas/portada-camaras.png"
              alt="Portada Cámaras y seguridad en el hogar"
