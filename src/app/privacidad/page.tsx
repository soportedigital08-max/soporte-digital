    ...
    <>
      ...
      <main className="flex-1 py-16">
        <div className="container max-w-3xl mx-auto prose">
          <h1 className="text-h1 text-gray-900">Política de Privacidad</h1>
          <p className="text-body text-gray-500 mt-2">
            Última actualización: 18 de julio de 2026.
          </p>

          <h2 className="text-h2 text-gray-900 mt-10">1. Quiénes somos</h2>
          <p className="text-body text-gray-700 mt-3">
          ...
          <h2 className="text-h2 text-gray-900 mt-10">2. Datos que recolectamos</h2>
          <p className="text-body text-gray-700 mt-3">
          ...
          <h2 className="text-h2 text-gray-900 mt-10">3. Cómo usamos tus datos</h2>
          <ul className="text-body text-gray-700 mt-3 list-disc pl-6 space-y-1">
          ...
          <h2 className="text-h2 text-gray-900 mt-10">4. Pasarelas de pago</h2>
          <p className="text-body text-gray-700 mt-3">
          ...
          <h2 className="text-h2 text-gray-900 mt-10">5. Conservación</h2>
          <p className="text-body text-gray-700 mt-3">
